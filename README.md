...
Each category page has its own accent color, all from the same warm orange family with a hint of green/olive on Nature for variety. Currently:

- Portraits → Clementine + Mandarin (the boldest)
- Products → Mandarin (deeper, more authoritative for pricing)
- Landscapes → Clementine + Olive
- Weddings → Mandarin + Clementine on cream
- Nature → Olive + Palm green (the only category leaning green)

The base site uses warm cream as the main background with mandarin/clementine as the lead accents. To adjust, edit the CSS variables at the top of `styles.css`.
